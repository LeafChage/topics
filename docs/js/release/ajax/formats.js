...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__27151){
...
var request = map__27152__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27152__$1,cljs.core.cst$kw$response_DASH_format);
...
var fexpr__27156 = cljs.core.cst$kw$read.cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__27156.cljs$core$IFn$_invoke$arity$1 ? fexpr__27156.cljs$core$IFn$_invoke$arity$1(response) : fexpr__27156.call(null,response));
});

ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__27157 = cljs.core.cst$kw$read.cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__27157.cljs$core$IFn$_invoke$arity$1 ? fexpr__27157.cljs$core$IFn$_invoke$arity$1(response) : fexpr__27157.call(null,response));
});
});

ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2;

ajax.formats.accept_header = (function ajax$formats$accept_header(p__27159){
...
var request = map__27160__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27160__$1,cljs.core.cst$kw$response_DASH_format);
