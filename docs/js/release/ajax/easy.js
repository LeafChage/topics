...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__27416 = cljs.core.second(format);
var G__27417 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__27416,G__27417) : ajax.easy.keyword_response_format_element.call(null,G__27416,G__27417));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27420_SHARP_){
return ajax.easy.keyword_response_format_element(p1__27420_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__27421){
var map__27422 = p__27421;
var map__27422__$1 = (((((!((map__27422 == null))))?(((((map__27422.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27422.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27422):map__27422);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27422__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27422__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27422__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__27422,map__27422__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__27424){
var vec__27425 = p__27424;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27425,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27425,(1),null);
var fexpr__27428_27429 = (cljs.core.truth_(ok)?h:e);
(fexpr__27428_27429.cljs$core$IFn$_invoke$arity$1 ? fexpr__27428_27429.cljs$core$IFn$_invoke$arity$1(result) : fexpr__27428_27429.call(null,result));
...
;})(h,e,map__27422,map__27422__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__27430){
...
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27431__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27431__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27431__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27431__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27431__$1,cljs.core.cst$kw$body);
