...
var G__27829 = o;
(G__27829[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__27830__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__27830 = function (var_args){
var args = null;
...
while (G__27831__i < G__27831__a.length) {G__27831__a[G__27831__i] = arguments[G__27831__i + 0]; ++G__27831__i;}
  args = new cljs.core.IndexedSeq(G__27831__a,0,null);
} 
return G__27830__delegate.call(this,args);};
G__27830.cljs$lang$maxFixedArity = 0;
G__27830.cljs$lang$applyTo = (function (arglist__27832){
var args = cljs.core.seq(arglist__27832);
return G__27830__delegate(args);
});
...
var G__27833 = o;
(G__27833[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__27834__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__27835__i < G__27835__a.length) {G__27835__a[G__27835__i] = arguments[G__27835__i + 0]; ++G__27835__i;}
  args = new cljs.core.IndexedSeq(G__27835__a,0,null);
} 
return G__27834__delegate.call(this,args);};
G__27834.cljs$lang$maxFixedArity = 0;
G__27834.cljs$lang$applyTo = (function (arglist__27836){
var args = cljs.core.seq(arglist__27836);
return G__27834__delegate(args);
});
...
var G__27838 = props;
var G__27838__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27838,cljs.core.cst$kw$id,id):G__27838);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27838__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__27839){
var map__27840 = p__27839;
var map__27840__$1 = (((((!((map__27840 == null))))?(((((map__27840.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27840.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27840):map__27840);
var props = map__27840__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27840__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__27840,map__27840__$1,props,class$){
return (function (c){
...
});})(map__27840,map__27840__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__27842){
var map__27843 = p__27842;
var map__27843__$1 = (((((!((map__27843 == null))))?(((((map__27843.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27843.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27843):map__27843);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27843__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__27843,map__27843__$1,on_write){
return (function (){
...
});})(node_value,map__27843,map__27843__$1,on_write))
);
} else {
...
var G__27846 = jsprops;
(G__27846["defaultValue"] = value);

(G__27846["onChange"] = ((function (G__27846,v,value,on_change){
return (function (p1__27845_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__27845_SHARP_);
});})(G__27846,v,value,on_change))
);
...
var vec__27849 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27849,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27849,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27849,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___27853 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___27853 == null)){
} else {
var key_27854 = temp__5724__auto___27853;
(jsprops["key"] = key_27854);
}
...
var temp__5724__auto___27855 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___27855 == null)){
} else {
var key_27856 = temp__5724__auto___27855;
reagent.impl.template.oset(jsprops,"key",key_27856);
}
...
var G__27857 = reagent.impl.template.__GT_NativeWrapper();
(G__27857["name"] = c);
...
var G__27858 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__27858) : reagent.impl.template.as_element.call(null,G__27858));
} else {
...
var len__4730__auto___27864 = arguments.length;
var i__4731__auto___27865 = (0);
while(true){
if((i__4731__auto___27865 < len__4730__auto___27864)){
args__4736__auto__.push((arguments[i__4731__auto___27865]));

var G__27866 = (i__4731__auto___27865 + (1));
i__4731__auto___27865 = G__27866;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq27862){
var G__27863 = cljs.core.first(seq27862);
var seq27862__$1 = cljs.core.next(seq27862);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27863,seq27862__$1);
});
...
break;
default:
var G__27869 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__27869;
continue;
...
var n__4607__auto___27871 = a.length;
var i_27872 = (0);
while(true){
if((i_27872 < n__4607__auto___27871)){
(a[i_27872] = reagent.impl.template.as_element((a[i_27872])));

var G__27873 = (i_27872 + (1));
i_27872 = G__27873;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___27874 = a.length;
var i_27875 = (0);
while(true){
if((i_27875 < n__4607__auto___27874)){
var val_27876 = (a[i_27875]);
if(((cljs.core.vector_QMARK_(val_27876)) && ((reagent.impl.template.key_from_vec(val_27876) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_27875] = reagent.impl.template.as_element(val_27876));

var G__27877 = (i_27875 + (1));
i_27875 = G__27877;
continue;
} else {
}
...
var ctx = ({});
var vec__27878 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27878,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27878,(1),null);
...
var G__27881 = (cljs.core.count(argv) - first_child);
switch (G__27881) {
case (0):
...
case (1):
var G__27882 = comp;
var G__27883 = jsprops;
var G__27884 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__27882,G__27883,G__27884) : reagent.impl.template.global$module$react.createElement.call(null,G__27882,G__27883,G__27884));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__27881){
