...
if((i < len)){
var k = (ks[i]);
var G__27761 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__27762 = (i + (1));
m = G__27761;
i = G__27762;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__27763 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__27763) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__27763));
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__27765 = c;
var G__27765__$1 = (((G__27765 == null))?null:G__27765.prototype);
if((G__27765__$1 == null)){
return null;
} else {
return (G__27765__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__27767 = c;
var G__27767__$1 = (((G__27767 == null))?null:G__27767.prototype);
if((G__27767__$1 == null)){
return null;
} else {
return (G__27767__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__27771__delegate = function (args){
var G__27769 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__27769) : reagent.impl.component.as_element.call(null,G__27769));
};
...
while (G__27772__i < G__27772__a.length) {G__27772__a[G__27772__i] = arguments[G__27772__i + 0]; ++G__27772__i;}
  args = new cljs.core.IndexedSeq(G__27772__a,0,null);
} 
return G__27771__delegate.call(this,args);};
G__27771.cljs$lang$maxFixedArity = 0;
G__27771.cljs$lang$applyTo = (function (arglist__27773){
var args = cljs.core.seq(arglist__27773);
return G__27771__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__27775 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__27776 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__27776;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__27775;
}});
...
return ((function (G__27777,G__27777__$1){
...
var c = this;
var G__27782_27784 = (c["cljsRatom"]);
if((G__27782_27784 == null)){
} else {
reagent.ratom.dispose_BANG_(G__27782_27784);
}
...
var renders_27786 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_27787 = cljs.core.first(cljs.core.vals(renders_27786));
if((cljs.core.count(renders_27786) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_27786))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_27787)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_27787], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__27785 = name;
switch (G__27785) {
case "":
...
var G__27790 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__27790) : reagent.impl.component.global$module$create_react_class.call(null,G__27790));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__27791 = fiber;
var G__27791__$1 = (((G__27791 == null))?null:(G__27791["type"]));
if((G__27791__$1 == null)){
return null;
} else {
return (G__27791__$1["displayName"]);
}
})();
var parent = (function (){var G__27792 = fiber;
if((G__27792 == null)){
return null;
} else {
return (G__27792["return"]);
}
})();
var path = (function (){var G__27793 = parent;
var G__27793__$1 = (((G__27793 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__27793) : reagent.impl.component.fiber_component_path.call(null,G__27793)));
if((G__27793__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27793__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__27795 = c;
if((G__27795 == null)){
return null;
} else {
return (G__27795["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__27796._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__27798 = c;
if((G__27798 == null)){
return null;
} else {
return (G__27798["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__27800 = c;
if((G__27800 == null)){
return null;
} else {
return G__27800._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__27802 = instance;
if((G__27802 == null)){
return null;
} else {
return (G__27802["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__27803 = instance;
if((G__27803 == null)){
return null;
} else {
return G__27803._currentElement;
}
}
})();
var name = (function (){var G__27804 = elem;
var G__27804__$1 = (((G__27804 == null))?null:(G__27804["type"]));
if((G__27804__$1 == null)){
return null;
} else {
return (G__27804__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__27806 = elem;
if((G__27806 == null)){
return null;
} else {
return (G__27806["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__27807._owner;
}
}
})();
var path = (function (){var G__27808 = owner;
var G__27808__$1 = (((G__27808 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__27808) : reagent.impl.component.component_path.call(null,G__27808)));
if((G__27808__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27808__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__27809 = c;
var G__27809__$1 = (((G__27809 == null))?null:G__27809.constructor);
if((G__27809__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__27809__$1);
}
}
})();
