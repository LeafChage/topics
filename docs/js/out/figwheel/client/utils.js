...
return (new CustomEvent(event_name,(function (){var obj31832 = ({"detail":data});
return obj31832;
})()));
} else {
...
var f = (function (){var pred__31839 = cljs.core._EQ_;
var expr__31840 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31839.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31840))){
return ((function (pred__31839,expr__31840){
return (function (p1__31833_SHARP_){
return console.warn(p1__31833_SHARP_);
});
;})(pred__31839,expr__31840))
} else {
if(cljs.core.truth_(pred__31839.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31840))){
return ((function (pred__31839,expr__31840){
return (function (p1__31834_SHARP_){
return console.debug(p1__31834_SHARP_);
});
;})(pred__31839,expr__31840))
} else {
if(cljs.core.truth_(pred__31839.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31840))){
return ((function (pred__31839,expr__31840){
return (function (p1__31835_SHARP_){
return console.error(p1__31835_SHARP_);
});
;})(pred__31839,expr__31840))
} else {
return ((function (pred__31839,expr__31840){
return (function (p1__31836_SHARP_){
return console.log(p1__31836_SHARP_);
});
;})(pred__31839,expr__31840))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31843){
...
var eval_fn = cljs.core.get.call(null,map__31844__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__31846_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__31848,(0),null);
var v = cljs.core.nth.call(null,vec__31848,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1555764113005
