...
var o22848 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22848["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22849 = temp__5718__auto____$1;
return (o22849["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21929__auto__ = f;
return (o__21929__auto__["toString"]).call(o__21929__auto__);
} else {
return "";
}
}catch (e22850){var _ = e22850;
return "";
}});
...
try{var o__21929__auto___22852 = t;
(o__21929__auto___22852["cljs$lang$ctorPrWriter"]).call(o__21929__auto___22852,t,writer);
}catch (e22851){var __22853 = e22851;
}
...
var char_code = (function (){var o__21929__auto__ = (new String(char$));
return (o__21929__auto__["charCodeAt"]).call(o__21929__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21929__auto__ = String;
return (o__21929__auto__["fromCharCode"]).call(o__21929__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22854 = num_code;
switch (G__22854) {
case (1):
return (185);
...
var o__21929__auto__ = String;
return (o__21929__auto__["fromCharCode"]).call(o__21929__auto__,superscript_code);
});
/**
...
}catch (e22856){var _e__21936__auto__ = e22856;
return false;
}})())){
...
var vec__22857 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22857,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o22860 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22860["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22861 = temp__5718__auto____$1;
return (o22861["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___22868 = arguments.length;
var i__4731__auto___22869 = (0);
while(true){
if((i__4731__auto___22869 < len__4730__auto___22868)){
args__4736__auto__.push((arguments[i__4731__auto___22869]));

var G__22870 = (i__4731__auto___22869 + (1));
i__4731__auto___22869 = G__22870;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22864){
var vec__22865 = p__22864;
var ns_detector = cljs.core.nth.call(null,vec__22865,(0),null);
...
var G__22871 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22872 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22871;
remaining_tokens = G__22872;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22862){
var G__22863 = cljs.core.first.call(null,seq22862);
var seq22862__$1 = cljs.core.next.call(null,seq22862);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22863,seq22862__$1);
});
...
var vec__22876 = cljs.core.split_with.call(null,(function (p1__22875_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22875_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22876,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22876,(1),null);
...
var vec__22882 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22882,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22882,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22885 = cljs.core.rest.call(null,remaining_tokens);
var G__22886 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22885;
name_tokens = G__22886;
continue;
} else {
...
var vec__22889 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22889,(0),null);
var arity = cljs.core.nth.call(null,vec__22889,(1),null);
var vec__22892 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22892,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22892,(1),null);
var vec__22895 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22895,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22895,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22895,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22895,(3),null);
...
var vec__22901 = result;
var munged_ns = cljs.core.nth.call(null,vec__22901,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22901,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22901,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22901,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22901,(4),null);
var arity = cljs.core.nth.call(null,vec__22901,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22905 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22905,(0),null);
var args = cljs.core.nth.call(null,vec__22905,(1),null);
var vec__22908 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22908,(0),null);
var name = cljs.core.nth.call(null,vec__22908,(1),null);
...
var G__22911 = (arity + (1));
var G__22912 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22913){
var vec__22914 = p__22913;
var arity = cljs.core.nth.call(null,vec__22914,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22914,(1),null);
...
return cljs.core.get.call(null,arities,p1__22917_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22918_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___22925 = arguments.length;
var i__4731__auto___22926 = (0);
while(true){
if((i__4731__auto___22926 < len__4730__auto___22925)){
args__4736__auto__.push((arguments[i__4731__auto___22926]));

var G__22927 = (i__4731__auto___22926 + (1));
i__4731__auto___22926 = G__22927;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22921){
var vec__22922 = p__22921;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22922,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22919){
var G__22920 = cljs.core.first.call(null,seq22919);
var seq22919__$1 = cljs.core.next.call(null,seq22919);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22920,seq22919__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22930__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22930__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22930__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22930__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22931 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22931,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22931,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22931,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22931,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22931,(4),null);
var arity = cljs.core.nth.call(null,vec__22931,(5),null);
...
var o__21929__auto__ = f;
return (o__21929__auto__["getBasis"]).call(o__21929__auto__);
});
/**
...
}catch (e22935){var _e__21936__auto__ = e22935;
...
var G__22936 = (obj[cljs.core.first.call(null,path)]);
var G__22937 = cljs.core.rest.call(null,path);
obj = G__22936;
path = G__22937;
continue;
} else {
...
return (function (accum,p__22938){
var vec__22939 = p__22938;
var bit = cljs.core.nth.call(null,vec__22939,(0),null);
var protocol = cljs.core.nth.call(null,vec__22939,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22942){
var vec__22943 = p__22942;
var ns = cljs.core.nth.call(null,vec__22943,(0),null);
var name = cljs.core.nth.call(null,vec__22943,(1),null);
var selector = cljs.core.nth.call(null,vec__22943,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__22948,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22948,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22948,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22946_SHARP_){
return (obj[cljs.core.first.call(null,p1__22946_SHARP_)]);
});})(name,sorted_matches,vec__22948,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1555764105237
