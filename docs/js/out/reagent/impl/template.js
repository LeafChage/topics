...
var G__26842 = o;
(G__26842[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__26843__delegate = function (args){
...
while (G__26844__i < G__26844__a.length) {G__26844__a[G__26844__i] = arguments[G__26844__i + 0]; ++G__26844__i;}
  args = new cljs.core.IndexedSeq(G__26844__a,0,null);
} 
return G__26843__delegate.call(this,args);};
G__26843.cljs$lang$maxFixedArity = 0;
G__26843.cljs$lang$applyTo = (function (arglist__26845){
var args = cljs.core.seq(arglist__26845);
return G__26843__delegate(args);
});
...
var G__26846 = o;
(G__26846[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__26847__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__26848__i < G__26848__a.length) {G__26848__a[G__26848__i] = arguments[G__26848__i + 0]; ++G__26848__i;}
  args = new cljs.core.IndexedSeq(G__26848__a,0,null);
} 
...
var args = cljs.core.seq(arglist__26849);
...
var G__26851 = props;
var G__26851__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__26851,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26851);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__26851__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__26852){
...
var props = map__26853__$1;
var class$ = cljs.core.get.call(null,map__26853__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__26853,map__26853__$1,props,class$){
return (function (c){
...
});})(map__26853,map__26853__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__26855){
...
var on_write = cljs.core.get.call(null,map__26856__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__26856,map__26856__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__26856,map__26856__$1,on_write))
);
} else {
...
var G__26859 = jsprops;
(G__26859["defaultValue"] = value);

(G__26859["onChange"] = ((function (G__26859,v,value,on_change){
return (function (p1__26858_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__26858_SHARP_);
});})(G__26859,v,value,on_change))
);
...
var vec__26862 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__26862,(0),null);
var id = cljs.core.nth.call(null,vec__26862,(1),null);
var class$ = cljs.core.nth.call(null,vec__26862,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___26866 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___26866 == null)){
} else {
var key_26867 = temp__5724__auto___26866;
(jsprops["key"] = key_26867);
}
...
var temp__5724__auto___26868 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___26868 == null)){
} else {
var key_26869 = temp__5724__auto___26868;
reagent.impl.template.oset.call(null,jsprops,"key",key_26869);
}
...
var G__26870 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__26870["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26874){
...
break;
default:
var G__26881 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__26881;
continue;
...
var n__4607__auto___26883 = a.length;
var i_26884 = (0);
while(true){
if((i_26884 < n__4607__auto___26883)){
(a[i_26884] = reagent.impl.template.as_element.call(null,(a[i_26884])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___26886 = a.length;
var i_26887 = (0);
while(true){
if((i_26887 < n__4607__auto___26886)){
var val_26888 = (a[i_26887]);
if(((cljs.core.vector_QMARK_.call(null,val_26888)) && ((reagent.impl.template.key_from_vec.call(null,val_26888) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_26887] = reagent.impl.template.as_element.call(null,val_26888));

var G__26889 = (i_26887 + (1));
i_26887 = G__26889;
continue;
} else {
}
...
var G__26893 = (cljs.core.count.call(null,argv) - first_child);
switch (G__26893) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__26893){
...
//# sourceMappingURL=template.js.map?rel=1555764110054
